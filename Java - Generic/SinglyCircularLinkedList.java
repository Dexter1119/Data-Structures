...
class node<T>
{
    ...
    // Description   : Initializes node<T> with data and sets next to null
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
...
class SinglyCLL<T>
{
    ...
    // Description   : Inserts node<T> at the beginning of the list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Inserts node<T> at a specific position
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Deletes the first node<T> in the list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Deletes the last node<T> in the list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    //
    // Function Name : Count
    // Description   : Returns number of node<T>s in the list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
