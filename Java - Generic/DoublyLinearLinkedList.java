...
class node<T>
{
    ...
    // Description   : Initializes node<T> with data, next & prev as null
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    // Prototype     : public node<T>(int no)
...
class DoublyLLL<T>
{
    ...
    // Description   : Inserts node<T> at the beginning of list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Inserts node<T> at the end of the list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Inserts node<T> at a given position
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Deletes first node<T> in the list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Deletes last node<T> in the list
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
    ...
    // Description   : Deletes node<T> at a given position
    // Author        : Pradhumnya Changdev Kalsait
    // Date          : 08/07/25
...
public class DoublyLinearLinkedList
{
    public static void main(String[] args)
    {
        ...
        DoublyLLL<Integer> dobj = new DoublyLLL<>();
